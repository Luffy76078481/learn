...
class MgGamesPage extends Component {
    ...
    render() {
        ...
        const GameListPanel3 = window.r.get("GameListPanel3");
        ...
        return (
            <div className="Mg-content">
                ...
                <div id="MGbg"> 
                {/* {GameListPanel2?<GameListPanel2 limitPlatform="MG2" id="MGbg"></GameListPanel2>
                        :<GameListPanel limitPlatform="MG2" id="MGbg"></GameListPanel>} */}
                        <GameListPanel3 limitPlatform="MG2" id="MGbg"></GameListPanel3>
