                ...
                <div className="maincontent">
                    ...
                    <div className="top">
                        ...
                        <div className="rightside_inpt float_right">
                            ...
                            <div className="input float_left promoCode">
                            <input id="recommendCode" value={"https://"+ location.hostname + "/register?channel=" +this.props.user.recommendCode} className="editable" readOnly/></div>
