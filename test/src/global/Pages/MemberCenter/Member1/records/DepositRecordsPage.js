...
class DepositRecordsPage extends Component {
    componentDidMount() {
        this.toPage();
    }
    renderRecords(){
               ...
               <div className="report-filter wraperh-sm">
                ...
                <table className="table-msg table-border f14 tc" width="100%">
                    ...
                    <tr className="wager all">
                        ...
                        <th className="member-th">存款单号</th>
                        <th className="member-th">存款方式</th>
                        <th className="member-th">存款金额</th>
                        <th className="member-th">存款状态</th>
                ...
                <PageBar toPage={this.toPage.bind(this)} page={this.props.records}/>
            </div>
        );
    }
}
