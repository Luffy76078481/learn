            ...
            <div className="divc w1000" style={{paddingBottom: "20px"}}>
                ...
                <div className="clearfix t20 ht-cunkuan deposit member-content">
                    <div className="t tc f14">
                        ...
                        {this.props.remoteSysConfs['allow_edit_pay_pwd'] == "true"? <Link to="/person_change_pay_pwd" className={this.props.location.pathname === '/person_change_pay_pwd'?'iblock on':'iblock'}>修改取款密码</Link> : null}
