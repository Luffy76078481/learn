...
class GamesPage extends Component {
    ...
    renderPlatfromList(){
        let platformLists = [];
        let selfPlatfromId =  this.state.selPlatformId;
        let index = 0;
        platformLists.push(
            <li key={98}  className={selfPlatfromId==""?"active":""}>
                <a title={"全部"}  onClick={this.onSelectPlatform.bind(this,"")}>
                    <svg className="icon"
    ...
    onSelectPlatform(platformID) {
        ...
        filter.GamePlatform = platformID;
        this.getList();
    }
    selfGames(){
