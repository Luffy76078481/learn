...
import {ListView, NavBar, Icon, SearchBar, Flex, Modal, Toast,Button } from 'antd-mobile';
        ...
        const row = (rowData) => {
            ...
            return (
                <Flex className="listItem" align="start">
                    <Flex.Item className="itemL" onClick={rowData.GameIdentify.indexOf("2$X")!=-1? _this.IntoRoom.bind(_this,rowData): _this.playGame.bind(_this,rowData)}>
        ...
        return(
            <div>
                ...
                <div className='scroll-content AllGamePage'>
                    ...
                    />
                    {
                        this.props.params.GameName.includes("棋牌") ? null :
                        <div className="tabs">
                            {tabs}
                        </div>
                    }
                ...
                {/* 加入棋牌房间 */}
                {
                      ...
                      >
                        <input ref="IntoRoomId" className="IntoRoomClass" type="number" maxLength="6" placeholder="请输入6位房间密码"  /><br/>
                      </Modal>
                }
            </div>
        )
