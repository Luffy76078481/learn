...
import {Icon,List,InputItem,NavBar,Modal,Toast,Checkbox,DatePicker,Switch} from "antd-mobile";
...
class RegisterPage extends Component{
    ...
    onRegister = (event) => {
        ...
        new window.actions.ApiRegisterAction (params).fly((respond)=>{
            ...
            if (respond.StatusCode === 0) {
                ...
                browserHistory.push("/money/deposit");
            } else {
    ...
    getVerifyCode(VerifyCode){//获取验证码
        this.setState({
    ...
    agreeRules = () => {
        this.setState({readRule: !this.state.readRule})
    }
    renderRightCon = () => {
        let dom = [
    ...
    render(){
        const rightCon = this.renderRightCon();
        ...
        return(
            <div className="regPage">
                <NavBar
                    mode="light"
                    leftContent={<span className="logo"></span>}
                    ...
                    <form onSubmit={this.onRegister}>
                        <List>
                            <div className="inputBox">
                                ...
                                <label className="label" htmlFor="userName">4-10位数字或字母组合</label>
                            </div>
                            <div className="inputBox">
                                <InputItem
                                    id="userPwd"
                                ...
                                <label className="label" htmlFor="userPwd">4-16位数字或字母组合</label>
                            </div>
                            <div className="inputBox">
                                <InputItem
                                    id="confirmPwd"
                                ...
                                <label className="label" htmlFor="confirmPwd">确认您的密码</label>
                            </div>
                            {   //真实姓名
                                ...
                                <div className="inputBox">
                                    ...
                                    <label className="label" htmlFor="realName">填写您的真实姓名</label>
                                </div> : null
                            }
                            {   //邮箱
                            ...
                            {   //手机号码
                                this.props.registerSetting.PhoneIsVisible ?
                                    <div className="inputBox">
                                        ...
                                        <label className="label" htmlFor="userTel">手机号方便我们联系您</label>
                                    </div> : null
                            }
                            {   //推广码
                        ...
                        {/*<label className="switch_btn">
                            <input type="checkbox" id="checkbox" checked={this.state.readRule}/>
                            <span className="slider round" onClick={this.agreeRules}/>
                        </label>
                        <span className="switch_text">我已阅读并同意<a href="/registerRule">游戏协议和规则</a></span>*/}

                        <List className="agree_rule">
                            <List.Item extra={
                                <Switch checked={this.state.readRule}
                                        color="#ffbb44"
                                        onChange={()=>{
                                            this.setState({readRule: !this.state.readRule})
                                        }}
                                ...
                                我已阅读并同意<a href="/registerRule">游戏协议和规则</a>
                            </List.Item>
                        </List>

                        <button className="btn registerBtn">立即注册</button>
                    </form>
                </div>
            </div>
        )
