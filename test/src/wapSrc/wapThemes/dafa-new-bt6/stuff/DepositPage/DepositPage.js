...
class DepositPage extends Component{
    ...
    renderonlinePay(){  //在线支付
        ...
        let onlinePayList =[];
        let index=0;
        let len = this.props.payOnline.length;
        for (let i = 0; i < len; i++) {
    ...
    render(){
        if(this.state.payTab === "ZXZF"){ //在线支付
            this.renderonlinePay();
        }else if(this.state.payTab === "YHZZ"){  //银行转账
            this.renderofflinepay();
        }else if(this.state.payTab === "ZXWY"){  //在线网银
                        ...
                        <Flex className="userCash">
                            <Flex.Item>
                                ...
                                <div className="itemR">
                                    ...
                                    <span>¥ {this.props.user.amount}</span>
                                </div>
                            </Flex.Item>
                            {/*<Flex.Item>
