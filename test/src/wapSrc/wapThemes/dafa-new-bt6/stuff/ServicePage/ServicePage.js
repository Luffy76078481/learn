                    ...
                    <Flex>
                        <List className="list">
                            <Item arrow="horizontal" onClick={this.serviceOpen.bind(this)}>
                                <i className="icon icon-comments"></i>7x24在线客服
                            </Item>
                            <Item arrow="horizontal" onClick={()=>browserHistory.push('/service/feedback')}>
                                <i className="icon icon-info-sign"></i>问题反馈
                            </Item>
                            <h5 className="title">联系我们</h5>
                            {
                                this.props.remoteSysConfs.online_service_phone?
                                    <Item>
                                        <i className="icon icon-phone"></i>电话：{this.props.remoteSysConfs.online_service_phone}
                                    </Item>:null
                            }
                            {
                            ...
                            }
                            {
                                this.props.remoteSysConfs.online_service_email?
                                    <Item >
                                        <i className="icon icon-envelope"></i>邮箱：{this.props.remoteSysConfs.online_service_email}
                                    </Item>:null
                            }
                            {
