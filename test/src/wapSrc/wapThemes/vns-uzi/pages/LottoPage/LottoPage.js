...
import {ApiQueryLuckyCountAction, ApiQueryLuckyDrawAction, ApiQueryLuckyWinnerAction, GlobePopBox} from "globalAction";
                        ...
                        {!this.state.showLeft ? null :
                            <div className="outbox">
                                ...
                                <div className="pop-box text">
                                    ...
                                    <p className="wz">4、凡是抽中“100元手机话费”的会员务必在中奖后，2小时内添加官网客服QQ：1115554332
                                        申请话费充值，逾期视为自动放弃；</p>
                                    ...
                                    <p className="wz">6、此“幸运大赚盘”活动为【威尼斯人】系统程序自动运行，中奖的概率完全遵循力学及自然概率，不涉及任何人工操作，抽奖结果以系统判定为准，不得争议；</p>
                            ...
                            <div className="outbox">
                                ...
                                <div className="pop-box text">
                                    ...
                                    <div className="wrap_box" style={{clear: 'both'}}>
                                        ...
                                        <p className="wz">2、【{config.appName}】娱乐场的所有优惠特为玩家而设，如发现以不诚实方式套取红利或任何威胁.滥用公司优惠等行为，公司保留冻结.取消该团体或个人账户及账户结余的权利。 </p>
                                        <p className="wz">3、若会员对活动有争议时，为确保双方利益，杜绝身份盗用行为，【{config.appName}】娱乐场有权要求会员向我们提供充足有效的文件，用以确认是否享有该优惠的资质。</p>
                                        <p className="wz">4、当参与优惠会员未能完全遵守、或违反、或滥用任何有关公司优惠或推广的条款，又或我们有任何证据有任何团队或个人投下一连串的关联赌注，籍以造成
                                            无论赛果怎样都可以确保可以从该存款红利或其他推广活动提供的优惠获利，【{config.appName}】娱乐场保留权利向此团队或个人停止、取消优惠或索回已支付的全部优惠红利。
                                            此外，公司亦保留权利向这些客户扣取相当于优惠红利价值的行政费用，以补偿我们的行政成本。
                                        </p>
                                        <p className="wz">5、【{config.appName}】娱乐场保留对活动的最终解释权；以及在无通知的情况下修改、终止活动的权利，适用于所有优惠。</p>
                                    </div>
                                </div>
                            </div>
                        }
