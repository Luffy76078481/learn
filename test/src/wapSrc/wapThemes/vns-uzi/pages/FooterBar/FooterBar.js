                ...
                <Flex className="navTabs">
                    <Flex.Item >
                        <IndexLink to="/" activeClassName="active">
                            <i className="icon icon-home"/>首页
                        </IndexLink>
                    </Flex.Item>
                    <Flex.Item>
                        <Link to="/money" activeClassName="active">
                            <i className="icon icon-money"/>资金管理
                        </Link>
                    </Flex.Item>
                    <Flex.Item>
                        <Link to="/hotActivity" activeClassName="active">
                            <i className="icon icon-pinterest"/>火热活动
                        </Link>
                    </Flex.Item>
                    <Flex.Item>
                        <Link to="/message" activeClassName="active">
                            <i className="icon icon-globe"/>我的消息
                            <Badge text={this.props.sitemsg.unread+this.props.noticesUnRead+this.props.promoUnRead} />
                        </Link>
                    </Flex.Item>
                    <Flex.Item>
                        <Link to="/history" activeClassName="active">
                            <i className="icon icon-paste"/>历史记录
                        </Link>
                    </Flex.Item>
                    <Flex.Item>
                        <Link to="/service" activeClassName="active">
                            <i className="icon icon-group"/>客户服务
                        </Link>
                    </Flex.Item>
                </Flex>
            </div>
