...
class HistoryPage extends Component{
    constructor(props) {
        ...
        this.state={
            ...
            endValue:new Date(),
            fromDate:window.Util.getNowDate(-7).slice(0,19),
            toDate:window.Util.getNowDate().slice(0,19)
        }
    }
    componentWillMount(){
        pageIndex=0;
    ...
    chooseTime(){
       ...
       this.setState({
           fromDate:window.Util.formatTime(beginTime).slice(0,19),
           toDate:window.Util.formatTime(endTime).slice(0,19),
           showTimeChoose:false,
           tabLoading:true
       },()=>{
           pageIndex=0;
