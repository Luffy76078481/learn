...
import {Flex, List,NavBar, Icon} from 'antd-mobile';
                    ...
                    <Flex>
                        <List className="list">
                            <Item arrow="horizontal" onClick={this.serviceOpen.bind(this)}>
                                <i className="icon icon-comments" />7x24在线客服
                            </Item>
                            <Item arrow="horizontal" onClick={()=>window.wapHistoryType.push('/service/feedback')}>
                                <i className="icon icon-info-sign" />问题反馈
                            </Item>
                            <Item arrow="horizontal" onClick={()=>window.wapHistoryType.push('/service/agentReg')}>
                                <i className="icon icon-file-alt" />代理注册
                            </Item>
                            <h5 className="title">联系我们</h5>
                            {
                                this.props.remoteSysConfs.online_service_phone?
                                    <Item>
                                        <i className="icon icon-phone" />电话：{this.props.remoteSysConfs.online_service_phone}
                                    </Item>:null
                            }
                            {
                                this.props.remoteSysConfs.online_service_qq?
                                    <Item>
                                        ...
                                        </i>QQ：{this.props.remoteSysConfs.online_service_qq}
                                    </Item>:null
                            }
                            {
                            ...
                            }
                            {
                                this.props.remoteSysConfs.online_service_email?
                                    <Item >
                                        <i className="icon icon-envelope" />邮箱：{this.props.remoteSysConfs.online_service_email}
                                    </Item>:null
                            }
                            {
