...
import CardManage from "../../wapGlobal/Pages/CardManage/CardManage";
...
import AffixService_Callback from "../../wapGlobal/Pages/AffixService/AffixService_Callback" //电话回访
//加载该站点自由的router
...
export default class Requirement extends BaseRequirement {
    constructor() {
        ...
        this.r("AffixService_Callback", AffixService_Callback);//首页电话回拨
    }
}