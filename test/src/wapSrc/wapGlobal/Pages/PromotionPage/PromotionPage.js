...
class PromotionPage extends Component{
    ...
    readNew(id){
        ...
        window.wapHistoryType.push('/read/0&'+id+'&goBack')
    }
    getList(){
        let _this = this;
            ...
            new window.actions.ApiQueryPromotionsAction(pageIndex,30).fly(resp=>{
                ...
                if(resp.StatusCode ==0){
                    if(pageIndex==0){
                        ...
                        resp.List.unshift
                        (
                            {id:"statement",linkTo:"hotActivity/statement",Title:"流水王",type:"link"},
                            {id:"lotto",linkTo:"hotActivity/lotto",Title:"大转盘",type:"link"}
                        )
                    }
                    pageIndex++;
