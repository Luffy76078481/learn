...
class ChessPopTX extends Component{
    ...
    getData(){
        ...
        if(tabsType == 0){
            ...
            new window.actions.ApiPromotionRecordsAction(
                {
    ...
    render(){
        return(
            <div className="chesspop-neibox HistoryPage">
                <p className="chesspop-white-titlefont chesspop-head">
                    <span className="chesspop-head-title">记录</span>
                </p>
                    ...
                    <SegmentedControl
                        values={
                            [
                                ...
                                <div className="tabsItem" key={3}>游戏记录</div>,
