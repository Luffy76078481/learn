...
class PromotionPage extends Component {
    ...
    onSelectType(typeId) {
        ...
        new window.actions.ApiQueryPromotionsAction(1,30, typeId).fly();
    }
            ...
            ret.push(
                <li key={i} className="wow fadeInUp animated" style={{visibility: "visible"}}>
                    <div className="promotions-list-content BGcolor-third promotions-border">
                        <div className="promotions-list-img" onClick={this.onSelectPromo.bind(this,promo.Id)} style={{background: "url("+window.config.prdImgUrl + promo.Img + ") no-repeat", cursor:"pointer"}}> </div>
