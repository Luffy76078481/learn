        ...
        return (
            <article id="bingo" className=" BGcolor-main">
                <div className="banner">
                    <ImageGallery width="100%" height={height} type="bingo_banner_imgs" imgtype='banner'/>
                </div>
                {rprops.supportCG ?
                    <div className="bingo-fname bingo-fname2">
                        <div className="container">
                            <div className="bing-desc-bbin wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                <h3>
                                    <div className="bingo-title-img3" style={{visibility: "visible", animationName: "fadeInUp"}}/>
                                </h3>
                                <span className="bing-desc-inco-bg"/>
                            ...
                            <div className="row bingo-platform-list">
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-pk10"/>
                                        <span className="color-third">北京赛车PK10</span>
                                    </a>
                                </div>
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-fcsd"/>
                                        <span className="color-third">福彩3D</span>
                                    </a>
                                </div>
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-pls"/>
                                        <span className="color-third">排列三</span>
                                    </a>
                                </div>
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-xglhc"/>
                                        <span className="color-third">香港六合彩</span>
                                    </a>
                                </div>
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-cqssc"/>
                                ...
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-ssxw"/>
                                ...
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-ogc"/>
                                        <span className="color-third">CG分分彩</span>
                                    </a>
                                </div>
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-cgc"/>
                                        <span className="color-third">CG1.5分彩</span>
                                    </a>
                                </div>
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'CG')} >
                                        <span className="bingo-platform-img bingo-platform-jndc"/>
                ...
                {rprops.supportKG ?
                    <div className="bingo-fname bingo-fname2">
                        <div className="container">
                            <div className="bing-desc-bbin wow fadeInUp animated"
                                 style={{visibility: "visible", animationName: "fadeInUp"}}>
                                <h3>
                                    <div className="bingo-title-img2"
                                         style={{visibility: "visible", animationName: "fadeInUp"}}/>
                                </h3>
                                <span className="bing-desc-inco-bg"/>
                                <p className="color-main">最全的彩票平台，最值得您信赖的移动端，一流的服务体验多样玩法<br/>
                            ...
                            <div className="row bingo-platform-list">
                                <div className="col-md-3 wow fadeInUp animated"
                                     style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)"
                                       onClick={this.onClickTCGame.bind(this, 'KG')}>
                                        <span className="bingo-platform-img bingo-platform-xglhc"/>
                                ...
                                <div className="col-md-3 wow fadeInUp animated"
                                    ...
                                    <a target="_blank" href="javascript:void(0)"
                                       onClick={this.onClickTCGame.bind(this, 'KG')}>
                                        <span className="bingo-platform-img bingo-platform-jndbs"/>
                                ...
                                <div className="col-md-3 wow fadeInUp animated"
                                    ...
                                    <a target="_blank" href="javascript:void(0)"
                                       onClick={this.onClickTCGame.bind(this, 'KG')}>
                                        <span className="bingo-platform-img bingo-platform-bjklb"/>
                    ...
                    <div className="container">
                        ...
                        <div className="row bingo-platform-list">
                            <div className="col-md-3 wow fadeInUp animated"
                                 style={{visibility: "visible", animationName: "fadeInUp"}}>
                                <a target="_blank" href="javascript:void(0)"
                                   onClick={this.onClickTCGame.bind(this, 'BBIN')}>
                                    <span className="bingo-platform-img bingo-platform-xglhc"/>
                                    <span className="color-third">六合彩</span>
                                </a>
                            </div>
                            ...
                            <div className="col-md-3 wow fadeInUp animated"
                                ...
                                <a target="_blank" href="javascript:void(0)"
                                   onClick={this.onClickTCGame.bind(this, 'BBIN')}>
                                    <span className="bingo-platform-img bingo-platform-tjsfc"/>
                            ...
                            <div className="col-md-3 wow fadeInUp animated"
                                ...
                                <a target="_blank" href="javascript:void(0)"
                                   onClick={this.onClickTCGame.bind(this, 'BBIN')}>
                                    <span className="bingo-platform-img bingo-platform-bbklc"/>
                            ...
                            <div className="col-md-3 wow fadeInUp animated"
                                ...
                                <a target="_blank" href="javascript:void(0)"
                                   onClick={this.onClickTCGame.bind(this, 'BBIN')}>
                                    <span className="bingo-platform-img bingo-platform-aysyq"/>
