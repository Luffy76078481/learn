...
class Footer extends Component {
    ...
    render() {
        ...
        return (
            ...
            <article id="footer-nav" className="BGcolor-third"><div className="container"><div className="row"><div className="col-md-5 right client-download ww fadeInUp"></div></div></div></article>
