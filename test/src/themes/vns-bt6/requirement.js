...
import Header from "./page/Header_new";
...
export default class Requirement extends BaseRequirement {
    constructor() {
        ...
        {
            this.r("GameListPanel2", GameListPanel2,{disableImageGallery:true,pgsize:30});
        }
        this.r("MgGamesPage", MgGamesPage);
        {
            this.r("GameListPanel3", GameListPanel3,{disableImageGallery:true,pgsize:30});
        }
