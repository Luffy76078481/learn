...
class RegisterPage extends Component {
    ...
    handleRegister(e) {
        ...
        if(this.props.registerSetting.EmailIsRequire && !this.refs.email.value){
            this.setState({
                noEmail:false
            });
            checknom++;
        }
        if(this.props.registerSetting.PhoneIsRequire && !this.refs.phone.value){
            this.setState({
                noPhone:false
            });
            checknom++;
        ...
        if(this.props.registerSetting.BirthdayIsRequire && !this.refs.birthday.getValue()){
            this.setState({
                noBirthday:false
            });
            checknom++;
        ...
        // , , , "",this.refs.password.value,referer,birthday,""
        // new window.actions.ApiRegisterAction (this.refs.username.value, "" ,this.refs.password.value, email, phone, "",this.refs.password.value,
            ).fly((respond)=>{
    ...
    render() {
        ...
        if( document.cookie||window.sessionStorage){
            storeChannel =  sessionStorage.getItem("channel") || getCookie("channel");
        }
                            ...
                            <div className="content">
                                ...
                                <div className="form-wrapper">
                                    <form onSubmit={this.handleRegister.bind(this)} className="registration-form ">
                                        ...
                                        <hr/>
                                        <div style={{"display":this.props.registerSetting.EmailIsVisible?"block":"none"}} className={"form-item " +(this.state.noEmail == null?"":this.state.noEmail?"has-success":"has-error")}>
                                            <label className="form-label">
                                        ...
                                        <div style={{"display":this.props.registerSetting.PhoneIsVisible?"block":"none"}} className={"form-item " +(this.state.noPhone == null?"":this.state.noPhone?"has-success":"has-error")}>
                                            <label className="form-label">
                                        ...
                                        <hr/>
                                        <div style={{"display":this.props.registerSetting.TrueNameIsVisible?"block":"none"}} className={"form-item " +(this.state.noRealname == null?"":this.state.noRealname?"has-success":"has-error")}>
                                            <label className="form-label">
                                        ...
                                        <div style={{"display":this.props.registerSetting.BirthdayIsVisible?"block":"none"}} className={"form-item " +(this.state.noBirthday == null?"":this.state.noBirthday?"has-success":"has-error")}>
                                            <label className="form-label">
                                        ...
                                        <div className={"form-item " +(this.state.noVerifycode?"":"has-error")}>
                                            ...
                                            <div className="form-field">
                                                ...
                                                <span className="form-help-block tag-color-apple-red" hidden={this.state.noVerifycode}>
                                                        {this.state.noVerifycodeMessage}</span>
                                            </div>
                                        </div>
                                        <hr/>
