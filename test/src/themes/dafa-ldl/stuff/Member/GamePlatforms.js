        ...
        for (var i = 0; i < this.props.game.platforms.length; i++) {
            ...
            ret.push(
                <div className="transferItem" key={i}>
                    ...
                    <a data-toggle="modal" data-target="#transferModal" onClick={this.props.transfer.bind(null,"to",platform.ID)}>转入</a>
                    <a data-toggle="modal" data-target="#transferModal" onClick={this.props.transfer.bind(null,"from",platform.ID)}>转出</a>
                    <a data-toggle="modal" data-target="#transferModal" onClick={this.props.transfer.bind(null,"all",platform.ID)}>转入其他游戏</a>
               </div>)
        }
        return ret;
    }
