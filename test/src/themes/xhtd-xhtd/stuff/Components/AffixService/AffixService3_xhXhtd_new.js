...
import "./AffixService3_xhXhtd_new.scss";
    ...
    render(){
        ...
        return (
            <div className="affix-online-server-3" style={{display: this.state.show ? "block":"none"}}>
                ...
                {/* <Link to="/register">
                    <div className='welcom_left'></div>
                </Link>
                <Link to="/deposit">
                    <div className='welcom_left_bottom'></div>
                    <div className='welcom_left_bottom2'></div>
                </Link>
                <div className='welcom_left_bottom3' onClick={this.close.bind(this)}></div> */}
            </div>
        );
    }
