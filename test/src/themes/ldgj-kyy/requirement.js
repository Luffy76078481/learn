...
import PromotionAlert from "./stuff/PromotionAlert/PromotionAlert";
...
export default class Requirement extends BaseRequirement {
    constructor() {
        ...
        this.r("Frame", Frame);
        {
            ...
            this.r("ImageGallery", ImageGallery, {sportHeight: "251px", bingoHeight: "251px", gameHeight: "200px",showBanner:true});
        }
        ...
        this.r("BingoPage", BingoPage, {supportKG:true,supportCG:true,supportFC:false});
