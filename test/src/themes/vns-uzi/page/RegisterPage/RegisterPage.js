...
import MyDatePicker from '../../../../global/Components/MyDatepicker/MyDatePicker_records.js';
                                    ...
                                    <div className="row regisdata">
                                        ...
                                        <div className="col-xs-12 col-md-12 input-marg">
                                            ...
                                            <div className="col-xs-6 col-md-6">
                                                ...
                                                <p className="wxts">贴心提醒：看不清？<span style={{color:"#fbd15f"}}>点击图片更换</span></p>
                                            </div>
                                        ...
                                        <div className="col-xs-12 col-md-12 input-marg daccept">
                                            ...
                                            <p className="reg-terms">
                                                ...
                                                <input type="checkbox" className="checkboxBg" id="disreceiveEmail"
                                                       ref="receiveEmail" defaultChecked="defaultChecked"/> 是的，我想收到威尼斯人的通讯</label>
                                            </p>
                                        </div>
                                    </div>
