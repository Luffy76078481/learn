    ...
    render(){
        return(
            <div className="AboutUs container">
                ...
                <p className="sssv28-about_text">我们提供各种安全简便的存款及提款方式给客户。我们一直坚持了解我们的客户(KYC)和反洗钱（AML）的原则，并与第三方的财务管理当局合作，用以确保在最大程度上遵从相关的法律及法规。 {config.appName} 希望所有的客户能够在一个安全愉快的环境中，享受本公司精心设计的产品和服务，並能够从中获利。我们欢迎客户对我们提出任何意见。如有需要，请通过电子邮件方式将相关意见发送至电子邮箱： <a href="mailto:cs@sss988.com">cs@sss988.com</a></p>
