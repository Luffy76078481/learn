    ...
    render(){
        return(
            <div className="AboutUs container">
                ...
                <p className="sssv28-about_text">{config.appName} 拥有並经营以下网站： <a href="http://sunbet.bet">sunbet.bet</a>。网站所提供的所有产品和服务皆由菲律宾政府卡格扬河经济特区First Cagayan Leisure and Resort Corporation (<a href="http://www.firstcagayan.com">www.firstcagayan.com</a>) 所授权和监管。本公司的经营理念是通过向顾客提供最佳的体育博彩及多元化网上娱乐，以进一步拓展我们的业务。</p>
                ...
                <p className="sssv28-about_text">我们提供各种安全简便的存款及提款方式给客户。我们一直坚持了解我们的客户(KYC)和反洗钱（AML）的原则，并与第三方的财务管理当局合作，用以确保在最大程度上遵从相关的法律及法规。 {config.appName} 希望所有的客户能够在一个安全愉快的环境中，享受本公司精心设计的产品和服务，並能够从中获利。我们欢迎客户对我们提出任何意见。如有需要，请通过电子邮件方式将相关意见发送至电子邮箱： <a href="mailto:365555800@qq.com">365555800@qq.com</a></p>
