...
class GamesPage extends Component {
    ...
    render() {
        ...
        const StreetMachine_tyc_tiger = window.r.get("StreetMachine_tyc_tiger");
        ...
        return (
            <div className="Games-content">
                ...
                <div id="Gamebg">
                    {window.config.spec == 'tyc'?
                        <StreetMachine_tyc_tiger selPlatformId={this.state.selPlatformId} />
                        :
