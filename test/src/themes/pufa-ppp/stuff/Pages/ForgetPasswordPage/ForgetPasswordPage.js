...
class ForgetPasswordPage extends Component {
    ...
    handleForgetPassword(e) {
        ...
        new window.actions.ApiForgetPwd1Action (this.refs.username.value,this.refs.method.value,this.refs.verifycode.value).fly();
        this.reVerifyCode()
                ...
                <div className="modal-dialog">
                    <div className="modal-content custom_modal_content">
                        <div className="modal-header">
                            <button type="button" className="close" data-dismiss="modal"><img src={require("../../images/xdialog.png")} alt="" className=""/></button>
