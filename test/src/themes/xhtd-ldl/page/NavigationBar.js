...
class NavigationBar extends Component {
    ...
    render() {
        ...
        const fishName = options.fishName || "捕鱼王";
                    ...
                    <ul className="main_nav">
                        <li>
                            <div className="nav_inbox navbx0">
                                ...
                                {!options.homeText ?
                                    <i className="glyphicon glyphicon-home f24 mt5"></i> : window.config.spec == 'hg' ? "网站首页" :
                                        "首页"}
                                </IndexLink>
                            </div>
                        </li>
                        ...
                        <li className="mainTitle n-bingo" onMouseEnter={menuHoverCallback.bind(this, "bingo")} onMouseLeave={menuHoverCallback.bind(this, false)}>
                            <div className="nav_inbox navbx4"><Link to="/bingo" activeClassName="active">{window.config.spec == 'xhUzi'?'彩票游戏':bingoName}</Link></div>
                            <ul className="items">
                        ...
                        {/*{window.config.spec == 'xpj2' ? <li className="mainTitle n-MT"><div className="nav_inbox navbx6"><Link to="/mt" activeClassName="active"><i className="glyphicon glyphicon-fire mr5 agFish"></i>MT棋牌</Link></div></li>:null}*/}
                        {window.config.spec == 'xhUzi'?null:<li className="mainTitle "><div className="nav_inbox navbx2 n-kaiyuan"><Link to="/streetMachine" activeClassName="active"><i className='glyphicon glyphicon-fire mr5 agFish'></i>棋牌</Link></div></li>}
                        {window.config.spec == 'xhUzi'?null:
                        ...
                        <div className="nav_inbox navbx7"><Link to="/ag" activeClassName="active">{window.config.spec == 'hg' ? null : <i className="glyphicon glyphicon-fire mr5 agFish"></i>}{fishName}</Link></div>
                        {!options.ag ? null :
                            <ul className="items">
                        ...
                        {/* <div className="nav_inbox navbx1"><Link activeClassName="active" to="/register">幸运转轮</Link></div> */}
                        <li className="mainTitle looto n-promo">
                            <div className="nav_inbox navbx1 "><Link activeClassName="active" to="/LootoPage">{window.promotionTag=="xpj"?<i className='glyphicon glyphicon-fire mr5 agFish'></i>:null}幸运转轮</Link></div>
                        </li>
                        <li className="mainTitle looto n-promo spec-lsw">
                                <div className="nav_inbox navbx1"><Link activeClassName="active" to="/SstateMent">{window.promotionTag=="xpj"?<i className='glyphicon glyphicon-fire mr5 agFish'></i>:null}流水王</Link></div>
                        </li>

                        {/* 利达国际(VIP客户)没有手机投注和优惠活动★★★★★★★★★★ */}
                        ...
                        <li className="mainTitle n-promo">
                            <div className="nav_inbox navbx9">
                                {window.config.spec == 'hg' ? <Link to="/promotions" className="anima" activeClassName="active">优惠活动</Link> :
                        ...
                        {window.config.spec == 'vns-vn2' || options.onlinserv == true ?
                            <li onClick={this.serversOpen.bind(this)}><div className="nav_inbox navbx9"><a className="spc-zxkf">在线客服</a></div></li>
                            : null
                        }
                        {!options.memberBtn ? null : window.config.spec == 'hg' ? null :
                            <li className="mainTitle member">
                                <div className="nav_inbox navbx1"><Link activeClassName="active" to="/register">会员注册</Link></div>
                            </li>
                        }
                        {!options.helpBtn ? null :
                            <li className="mainTitle member">
                                <div className="nav_inbox navbx10"><a href="/help.html" target="_blank">帮助中心</a></div>
                            </li>
                        }
