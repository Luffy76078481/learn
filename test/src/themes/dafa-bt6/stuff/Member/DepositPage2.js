...
//     ApiOfflineAccountsAction, ApiQueryOrderAction,ApiPlayerInfoAction, ApiQuery,ApiOfflineTransferTypesAction} from "../../../../actions/index";
import {
...
class DepositPage extends Component {
    ...
    renderTabsUl(){
        ...
        for (let i = 0; i < this.props.payThirdInfos.length; i++) {
            let p = this.props.payThirdInfos[i];1
            let code = p.BankNo;
            ret.push(
