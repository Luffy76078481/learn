        ...
        return (
            <nav role="navigation" className="Navigation">
                <ul className="main_nav">
                    ...
                    <div className="nav_inbox navbx7"><Link to="/ag" activeClassName="active"> <i className="glyphicon glyphicon-fire mr5 agFish"></i>AG捕鱼</Link></div>
                    </li>
                    <li className="mainTitle n-AG" onMouseEnter={menuHoverCallback.bind(this, "agFish")} onMouseLeave={menuHoverCallback.bind(this, false)}>
                    <div className="nav_inbox navbx7"><Link to="/LootoPage" activeClassName="active"> <i className="glyphicon glyphicon-fire mr5 agFish"></i>幸运转轮</Link></div>
                    </li>
                    <li className="bomb">
