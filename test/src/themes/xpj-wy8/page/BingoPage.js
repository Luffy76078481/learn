                    ...
                    <div className="bingo-fname bingo-fname3">
                        <div className="container">
                            <div className="bing-desc-bbin wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                <h3>
                                    <div className="bingo-title-img4" style={{visibility: "visible", animationName: "fadeInUp"}}></div>
                                </h3>
                            ...
                            <div className="row bingo-platform-list">
                                ...
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'FC')} >
                                    <span className="bingo-platform-img bingo-platform-pcdd"></span>
                                ...
                                <div className="col-md-3 wow fadeInUp animated" style={{visibility: "visible", animationName: "fadeInUp"}}>
                                    <a target="_blank" href="javascript:void(0)" onClick={this.onClickTCGame.bind(this,'FC')} >
                                    <span className="bingo-platform-img bingo-platform-ks"></span>
