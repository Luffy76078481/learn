...
class BindThirdPayPage extends Component {
    ...
    render() {
        ...
        <div className="security_pg bindCard">
            <h2 className="title">绑定支付宝、微信</h2>
            <div className="tabs_holder">
                <div className="table-responsive withdrawrectbl">
                    <table className="table">
                        ...
                        <tbody>
                        {this.renderUserBank().length==0?(<tr><td colSpan={3} >暂无数据</td></tr>):this.renderUserBank()}
                        </tbody>
                    </table>
                </div>
            </div>
            <div className="wrdbot">
                    ...
                    <div className="custbtn">
                        ...
                        <button onClick={this.onSubmit.bind(this)} className="btn">绑定新渠道</button>
                    </div>
                </div>
