            ...
            <div>
                ...
                <div className="maincontent security_pg withdrawalfund">
                    ...
                    <form onSubmit={this.onSubmit.bind(this)}>
                        {/*<div className="wtop_hlder">*/}
                            {/*<div className="wdrtop">*/}
                                {/*<div className="col-xs-6 unpadding"><div className="wlbl">每笔最少提款：</div> <span>1</span></div><div className="col-xs-6"><div className="wlbl">每笔最多提款：</div><span>1，000</span></div><div className="clearfix"></div>*/}
                                {/*<div className="col-xs-6 unpadding"><div className="wlbl">每日最多提款：</div> <span>3，000</span></div><div className="col-xs-6"><div className="wlbl">每天提款次数：</div><span>3</span></div><div className="clearfix"></div>*/}
                            {/*</div>*/}
                        {/*</div>*/}
