                ...
                <main className="main">
                    ...
                    <div className="container">
                        <div id="vip-level-card-section" className="level-card-section">
                            <div className="section-divider" style={{"marginLeft":"53px"}}></div>
                        ...
                        <section className="rewards-recognition">
                            ...
                            <p className="text-align-center mb-25"><strong>畅享VIP荣尊体验，尽在澳门新葡京</strong></p>&#13;
                            &#13;
                            <table border="1" cellPadding="1" cellSpacing="1" style={{width: '100%'}}>
                                <tbody>
                                <tr><td style={{background:"rgb(80, 47, 42)", width: "461px"}}></td>&#13;
                                <td className="text-white" style={{background:'rgb(80, 47, 42)',textAlign:'center',verticalAlign:'middle',width:'245px'}}><span className="icon-vip-bronze"></span><br />&#13;
                                    青铜</td>&#13;
                                <td className="text-white" style={{background:'rgb(80, 47, 42)',textAlign:'center',verticalAlign:'middle',width:'245px'}}><span className="icon-vip-silver"></span><br />&#13;
                                    白银</td>&#13;
                                <td className="text-white" style={{background:'rgb(80, 47, 42)',textAlign:'center',verticalAlign:'middle',width:'245px'}}><span className="icon-vip-gold"></span><br />&#13;
                                    黄金</td>&#13;
                                <td className="text-white" style={{background:'rgb(80, 47, 42)',textAlign:'center',verticalAlign:'middle',width:'245px'}}><span className="icon-vip-platinum"></span><br />&#13;
                                    铂金</td>&#13;
                                <td className="text-white" style={{background:'rgb(80, 47, 42)',textAlign:'center',verticalAlign:'middle',width:'245px'}}><span className="icon-vip-zuanshi"></span><br />&#13;
                                    钻石</td>&#13;
                            ...
                            <p>6.生日礼金需在生日当天将本人手持身份证正反面照片发送至客服邮箱365555800@qq.com进行申请。</p>
                            <p>7.会员VIP等级只升不降。</p>
