            ...
            <nav role="navigation" className="Navigation">
                <ul className="main_nav">
                    ...
                    <li className="mainTitle n-games" onMouseEnter={menuHoverCallback.bind(this, "games")} onMouseLeave={menuHoverCallback.bind(this, false)}>
                        <div className="nav_inbox navbx3"><Link to="/games" activeClassName="active">电子游戏</Link></div>
                    </li>
                    <li className="mainTitle n-games" onMouseEnter={menuHoverCallback.bind(this, "games")} onMouseLeave={menuHoverCallback.bind(this, false)}>
                        <div className="nav_inbox navbx3"><Link to="/PT" activeClassName="active">PT老虎机</Link></div>
                    </li> 
                    <li className="mainTitle n-games" onMouseEnter={menuHoverCallback.bind(this, "games")} onMouseLeave={menuHoverCallback.bind(this, false)}>
                        <div className="nav_inbox navbx3"><Link to="/MG" activeClassName="active">MG老虎机</Link></div>
                    </li> 
                    <li className="mainTitle n-games"><div className="nav_inbox navbx2 "><Link to="/streetMachine" activeClassName="active">棋牌对战</Link></div></li>
                    <li className="mainTitle n-AG" onMouseEnter={menuHoverCallback.bind(this, "agFish")} onMouseLeave={menuHoverCallback.bind(this, false)}>
                        <div className="nav_inbox navbx7"><Link to="/ag" activeClassName="active"> <i className="glyphicon mr5 agFish"></i>捕鱼达人</Link></div>
                    </li>
                    ...
                    <li className="mainTitle spec-liushui n-news">
                        <div className="nav_inbox navbx10 spec-liushui">
                            <Link to="/LootoPage" activeClassName="active"><i className="glyphicon mr5 mt5 agFish"></i>幸运转轮</Link>
                        </div>
                    </li>
                    <li className="mainTitle n-news">
                    ...
                    <li className="mainTitle n-promo" >
                        <a href="http://xpjzixun.com/" target="_blank">线路检测</a>
                    </li>
                    <li className="bomb" >
                        <div className="nav_inbox navbx8">
                            <a href={promotionLink} target="_blank"><i className="glyphicon mr5 mt5"></i>手机投注</a>
                        </div>
                     </li>
                </ul>
            </nav>
