                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 content-bingo wow fadeInUp" data-wow-duration="1.5s">
                                ...
                                <div className="content-bingo-offers" data-wow-duration="2s" data-wow-delay="1s">
                                    <a href="/promotions" className="color-main"><i className="glyphicon glyphicon-fire"></i>1980奖金模式,圆角投注 <span className="btn-type border-type"><i className="glyphicon glyphicon-gift mr5 mt5"></i>更多优惠</span></a>
                                </div>
                            </div>
