                        ...
                        <div className="sportsContent-border" onClick={this.onTo.bind(this, "/sport")}>
                            <div className="sportsContent">
                                <div className="sportsContentHead">
                                    <img src={require("./images/bet365_firstpage/bg-sports-title-white.gif?v=1")}/></div>
                                <div className="sportsContentRight">
                                    <div className="sportsContentLogin"><Link to="/sport">
                                        <img src={require("./images/bet365_firstpage/NCDBP_210x204.gif?v=1")}/></Link></div>
                                    <div className="sportsContentHref">
                                        ...
                                        <Link to="/sport">
                                            <img src={require("./images/bet365_firstpage/204x30-live-streaming-02.gif?v=1")}/>
                                                <span className="sportsContentHref-title">观看现场体育</span>
                                                <span className="sportsContentHref-text">每年我们向您的电脑提供超过<br/>
                                            70,000场的现场赛事链接。</span>
                                                <span className="sportsContentHref-btn">立即投注</span>
                                        </Link>
                                    </div>
                        ...
                        <div className="contentList">
                            <div className="contentListOl" onClick={this.onTo.bind(this, "/casino")}>
                                <div className="casino">
                                    <div className="casino-title"><a href="casino">
                                        <img src={require("./images/bet365_firstpage/bg-casino.jpg?v=1")} height="81"/></a></div>
                            ...
                            <div className="contentListOl pokerStyle" onClick={this.onTo.bind(this, "/bingo")}>
                                <div className="poker">
                                    <div className="casino-title"><a href="bingo">
                                        <img src={require("./images/bet365_firstpage/cp.jpg?v=1")} height="81"/></a></div>
                                    <div className="casino-content">
                            ...
                            <div className="contentListOl gameStyle" onClick={this.onTo.bind(this, "/games")}>
                                <div className="game">
                                    <div className="casino-title"><a href="game_all">
                                        <img src={require('./images/bet365_firstpage/PharaohTreasure.jpg')} height="81"/></a></div>
                                    <div className="casino-content">
                            ...
                            <div className="contentListOl gameStyle" onClick={this.onTo.bind(this, "/casino")}>
                                <div className="game">
                                    <div className="casino-title"><a href="new_casino">
                                        <img src={require("./images/bet365_firstpage/bg-poker.jpg?v=1")} height="81"/></a></div>
                                    <div className="casino-content">
                                        <img src={require("./images/bet365_firstpage/bg-liveCasino-title.gif?v=1")}/>
                                            <h4>新玩家奖金</h4>
                ...
                <div className="footer">
                    <div className="footer-desion">
                         <div className="footerLinks">
                            ...
                            <span className="ban">© 2001-2018 bet365 版权所有 | 18+</span>
                         </div>
                         ...
                         <span className="kong">
                           ...
                           <span className="kong">
                            ...
                            <span className="kong">我们向客户提供全部体育范围内的丰富投注，内容涵盖足球、网球、篮球、斯诺克及乒乓球等。投注一系列丰富的赛前及滚球盘盘口，无限精彩尽在每一场英超联赛和欧冠联赛足球现场比赛中，且我们的欧洲精英足球奖金优惠同样适用。此外，您还可以使用网球过关投注奖金尽享ATP网球顶级赛事带来的众多诱人投注机会。您可同时通过手机或平板电脑访问“移动中的Bet365”，体验一系列同样精彩诱人的赛事及盘口，包括现场滚球盘服务。为增加滚球盘的兴奋感受，我们还特别推出了现场链接，每年向您的电脑直播70,000多场精彩赛事。精选包括大师系列赛网球锦标赛和来自世界各地顶尖的国家级足球联赛。如想查看最新的体育投注信息，请访问我们全新的投注新闻站点。
