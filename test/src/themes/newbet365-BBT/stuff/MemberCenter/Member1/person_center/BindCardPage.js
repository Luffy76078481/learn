            ...
            <div id="bindCardPage" className="c">
                ...
                <form className="card_form">
                    ...
                    <div className="col-md-6 col-md-offset-3 dis" style={{display:this.state.selTab==="t2"?"block":"none"}}>
                        ...
                        <div className="input-group" style={{width:'335px'}}>
                            <span className="input-group-addon address-input" style={{"width":"88px"}}>开户省/市：</span>
                            <select  style={{width:"100px"}} ref="province" name="fr_bankprovince" className="select w128 prov member-input address" onChange={this.onSelectProvince.bind(this)}>
                                {bankAreas}
                            </select>
                            <select  style={{marginLeft:"7px",width:"130px"}} ref="city" name="fr_bankcity" className="select w128 prov member-input address">
                                {bankCities}
                            </select><br/>
                            <span className="red ml5 f12" >*请选择开户省/市</span>
                        </div>
                        {/*<div className="input-group">*/}
