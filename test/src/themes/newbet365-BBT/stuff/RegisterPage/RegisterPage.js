...
// import MyDatePicker from '../../../../../Components/MyDatepicker/MyDatePicker_records.js';
                                ...
                                <form onSubmit={this.handleRegister.bind(this)}>
                                    <div className="row">
                                        <div className="col-xs-12 col-md-12">
                                            <p className="col-xs-6 col-md-6"><i className="fa fa-star" aria-hidden="true" />用户名</p>
                                            <div className="col-xs-6 col-md-6">
                                                <input ref="username" type="text" placeholder="6-12位由字母和数字组成" onInput={this.checkUserName} maxLength="12" className="input member-input"/>
                                        ...
                                        }
                                        {
                                            this.props.registerSetting.BirthdayIsVisible ?
                                                <div className="col-xs-12 col-md-12 input-marg">
                                                    ...
                                                    <div className="col-xs-6 col-md-6">
                                                        <MyDatePicker placeholder="请填写您的生日" ref="birthday" className="registerDatePick myDatePick"></MyDatePicker>
                                        ...
                                        </div>
                                        {
                                            this.props.registerSetting.AgentExtendCodeIsVisible?
                                                (
                                                    // style={{display: channel ? "none":"block"}}

                                                    <div className="col-xs-12 col-md-12 input-marg" >
                                                        <p className="col-xs-6 col-md-6">推广码</p>
                                                        <div className="col-xs-6 col-md-6">
                                                        {channel?
                                                                 <input ref="channel" readOnly  type="text" placeholder="请输入推广码(可不填写)" defaultValue={channel}
                                                                 className="input member-input"/>
                                        ...
                                        <div className="col-xs-12 col-md-12 input-marg daccept">
                                            <p className="reg-terms">
                                                ...
                                                <input type="checkbox" className="checkboxBg" id="dacceptService"
                                                       ref="acceptService" defaultChecked="defaultChecked"/> 确认已年满18岁，并已阅读和接受本网站政策、隐私声明、<a onClick={this.openRule.bind(this)}></a>条款和条件。</label>
                                            </p>
                                            <p className="reg-terms">
                                                <label>
