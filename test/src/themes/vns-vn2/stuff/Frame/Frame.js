    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                {window.config.spec=='bet365' && this.props.message.popup && !this.state.expand?
                    <div className={"popupArea bet365Toast"}>
                        <div>    
                            <span className="popupTitle bet365title">{this.props.message.popup.title}</span>
                            <span className="popupMsg bet365Msg">{this.props.message.popup.message}</span>
                        </div>
                    </div> :<div></div>}
