                                    ...
                                    <div className="row">
                                        <div className="col-xs-12 col-md-12">
                                            ...
                                            <div className="col-xs-6 col-md-6">
                                                <input ref="username" type="text" placeholder="6-12位由字母和数字组成" className="input w238 member-input" onBlur={this.inputBlur.bind(this)} />&nbsp;
                                        ...
                                        {this.props.registerSetting.TrueNameIsVisible? 
                                            <div className="col-xs-12 col-md-12 input-marg">
                                                <p className="col-xs-6 col-md-6">{this.props.registerSetting.TrueNameIsVisible?<i className="fa fa-star" aria-hidden="true"></i>:null}真实姓名 </p>
                                                <div className="col-xs-6 col-md-6">
                                        ...
                                        {this.props.registerSetting.BirthdayIsVisible?
                                                <div className="col-xs-12 col-md-12 input-marg">
                                                    ...
                                                    <div className="col-xs-6 col-md-6">
                                                     {/* 日历插件 */}
                                                     <MuiThemeProvider>
                                                        <MyDatePicker ref="birthday" className="registerDatePick .input"></MyDatePicker>
                                                    </MuiThemeProvider>
