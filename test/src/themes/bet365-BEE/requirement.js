...
import FirstPage                from "./page/FirstPage_BEE";
import SportPage                from "./stuff/SportPage";
import FanyaEs                  from "./stuff/FanyaEs";// FY电竞
...
/*每个站点自己的router*/
import RequireSelfRouter        from "./RequireSelfRouter"; //电竞
...
export default class Requirement extends BaseRequirement {
    constructor() {
        ...
        this.r("Frame", Frame);
        this.r("FanyaEs", FanyaEs);
        {
            this.r("AffixService", AffixService);
            // this.r("AffixService2", AffixService2);
            this.r("Header", Header,{loginTxt:'登入',agentName:'申请代理',agentLogin:true,vipName:'VIP'});
            {
                this.r("NavigationBar", NavigationBar,{wapDownloadName:"手机app下载"});
                // this.r("AffixHongbao", AffixHongbao, {page:"/hongbao/xhUzi_hb.htm"});

            }
            this.r("Footer", Footer,{footerNav:true});
            this.r("NoticeBar", NoticeBar);
            this.r("ImageGallery", ImageGallery, {sportHeight: "251px", bingoHeight: "400px", gameHeight: "200px",showBanner:true});
        }
