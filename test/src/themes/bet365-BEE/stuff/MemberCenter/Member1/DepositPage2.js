                ...
                {self.state.selAdminAccount ?
                    <div className="offlineBankInfo ">
                        ...
                        <div className="bankPay">
                            <p>
                                <label>帐户名：</label>
                                <span style={{'color':'red'}}>{self.state.selAdminAccount.AccountName}</span>
                            </p>                  
                            <p>
                                <label>银行卡号：</label>
                                <span onClick={this.openLink} style={{'color':'#000','cursor':'pointer'}}>{self.state.selAdminAccount.AccountNo}</span>
                            </p>       
                            <p>
                                <label>银行：</label>
                                <span>{self.state.selAdminAccount.Bank.BankName}</span>
