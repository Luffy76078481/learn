...
class ChangePayPwdPage extends Component {
    ...
    onChangePsw(event){
        ...
        new ApiChangePayPwdAction(this.refs.old_psw.value,this.refs.new_psw.value).fly();
    }
    ...
    render() {
        return (
            <div className="c">
                <form method="" onSubmit={this.onChangePsw.bind(this)}>
                    <table className="ht-fktable f14" width="100%">
                        <tbody><tr>
                            <td width="35%" className="tr">旧取款密码：</td>
                            <td width="65%">
                                ...
                                <span className="ml5 red f12" hidden={this.state.oldPassword}>*此欄不能為空</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="65%">
                                ...
                                <span className="ml5 red f12" hidden={this.state.notMatchPswHid}>*密碼不相符</span>
                            </td>
                        </tr>
                        <tr>
                            <td width="35%" className="tr">&nbsp;</td>
                            <td width="65%">
                                <input type="submit" className="htbtnlg w260 t20 btn-type" value="确认并提交"/>
                            </td>
                        </tr>
                        </tbody></table>
                </form>
...
export default connect(mapStateToProps, {})(ChangePayPwdPage);