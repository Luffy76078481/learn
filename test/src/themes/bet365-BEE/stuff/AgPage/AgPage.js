...
class AgPage extends Component {
    ...
    render() {
        ...
        return (
            <article id="ag-game">
                <ul>
                    <li className="by-BBIN" onClick={this.onClickGameLink.bind(this, bbinLink)}></li>
                    <li className="by-AG" onClick={this.onClickGameLink.bind(this, gameLink)}></li>
                    <li className="by-PT" onClick={this.onClickGameLink.bind(this, gameLink)}></li>
                </ul>
